...
if(isset($_POST['submit-registration'])){
    ...
    if(empty($username)){
        $errors->add('empty_id', 'Please enter your ID');
    }

    if(empty($role)){
        $errors->add('empty_role', 'Please choose your role');
    }
    // sanitize role
    ...
    if(username_exists($username)){
        $errors->add('username_exists', 'Already exists user name');
    }

    if(empty($password)){
        $errors->add('empty_password', 'Please enter password');
    }
...
<head>
    ...
    <title>Simulator Registration</title>
    <?php wp_head(); ?>
</head>
<body>
    <main>
        <div class="login-container">
            ...
            <form method="post" action="">
                <div class="input-wrapper">
                    ...
                    <input type="text" name="user-id" id="user-id" placeholder="YOUR ID" required>
                </div>
                <div class="input-wrapper">
                    ...
                    <input type="text" name="user-password" id="user-password" placeholder="PASSWORD" required>
                </div>
                <div class="input-wrapper role-wrapper">
                    ...
                    <div class="">
                        ...
                        <label class="radio-label" for="instructor">Instructor</label>
                    </div>
                </div>
                <div class="input-wrapper">
                    <input type="submit" name="submit-registration" value="Sign Up">
                </div>
            </form>
